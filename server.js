...
const connectOptions = { useNewUrlParser: true, useCreateIndex: true, useUnifiedTopology: true, useFindAndModify: false };
connect(uri, connectOptions).then().catch((err) => console.log('Error:' + err));
